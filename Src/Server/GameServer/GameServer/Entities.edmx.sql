...
-- --------------------------------------------------
-- Date Created: 11/26/2022 18:45:51
-- Generated from EDMX file: D:\MyProgram\UnityProjectGit\mmorpgv8.3\mmorpg\Src\Server\GameServer\GameServer\Entities.edmx
-- --------------------------------------------------
...
-- Creating foreign key on [Owner_ID] in table 'CharacterItems'
ALTER TABLE [dbo].[CharacterItems]
...
-- Creating foreign key on [Owner_ID] in table 'CharacterQuests'
ALTER TABLE [dbo].[CharacterQuests]
